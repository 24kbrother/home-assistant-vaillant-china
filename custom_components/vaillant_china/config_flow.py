"""Config flow for Vaillant China integration."""
...
class VaillantChinaConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Vaillant China."""
